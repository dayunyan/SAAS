...
def train_haze():
    ...
    criterion = [nn.CrossEntropyLoss(), CAM_Loss, ClsConsis_Loss]
    ...
    print("Train finish!")
    # 保存模型
    model_path = MODE.model_woPerloss_paths
...
def test_haze():
    ...
    model.load_state_dict(
        torch.load(MODE.model_woPerloss_path, map_location=args.device)
    )
    # print(model)
    model.eval()
