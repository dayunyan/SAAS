...
python classification_lw_recons.py --mode $MDOE --data_name $DATANAME --cls_model resnet --device $CUDA --batchsize1 16 --cam $CAM
# python classification_lw.py --mode $MDOE --data_name $DATANAME --cls_model resnet --device $CUDA --batchsize1 16 --cam $CAM

# python make_cam_lw.py --mode $MDOE --data_name $DATANAME --device $CUDA --cam $CAM
